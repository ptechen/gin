...
func TestJsonLogger(t *testing.T) {
	router := New()
	router.Use(JsonLoggerWithWriter(JsonLoggerConfig{
		Output:    buffer,
		IsConsole: false,
		LogColor:  false,
	}))
...
func TestJsonLoggerConfig_Monitor(t *testing.T) {
	...
	router.Use(JsonLoggerWithWriter(JsonLoggerConfig{Output: f}))
	router.GET("/example", func(c *Context) {})
...
func TestJsonLoggerConfig_DeleteLogFile(t *testing.T) {
	router := New()
	router.Use(JsonLoggerWithWriter(JsonLoggerConfig{Output: buffer}))
	router.GET("/example", func(c *Context) {})
